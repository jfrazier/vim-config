...
"                dP   `YP `88888P' dP `88888P' dP............zzzzzzzzzzalt
".
"
...
" Then add the line "colorscheme kolorzalt" in your vimrc file, and restart Vim.
"
" --------------------------------------------------------------------------
" OPTIONS
" --------------------------------------------------------------------------
...
let g:colors_name="kolorzalt"


if !exists("g:kolorzalt_bold")
  let g:kolorzalt_bold=1
endif
if !exists("g:kolorzalt_italic")
  let g:kolorzalt_italic=1
endif
if !exists("g:kolorzalt_underlined")
  let g:kolorzalt_underlined=0
endif
if !exists("g:kolorzalt_alternative_matchparen")
  let g:kolorzalt_alternative_matchparen=0
endif
...
if g:kolorzalt_bold==0
  ...
  if g:kolorzalt_alternative_matchparen==0
...
if &t_Co > 255
  ...
  highlight Folded          ctermfg=32     ctermbg=234     cterm=none
  highlight FoldColumn      ctermfg=32     ctermbg=234     cterm=none
  ...
  highlight PmenuSbar       ctermfg=38     ctermbg=235     cterm=none
  ...
  highlight Comment         ctermfg=236     ctermbg=none    cterm=none
  highlight Constant        ctermfg=251     ctermbg=none    cterm=none
  highlight Special         ctermfg=252     ctermbg=none    cterm=none
  highlight Identifier      ctermfg=10      ctermbg=none    cterm=none
  highlight PreProc         ctermfg=32      ctermbg=none    cterm=none
  highlight String          ctermfg=32      ctermbg=none    cterm=none
  highlight Number          ctermfg=32      ctermbg=none    cterm=none
  highlight Function        ctermfg=251     ctermbg=none    cterm=none
  highlight htmlEndTag      ctermfg=252     ctermbg=none    cterm=none
  highlight xmlEndTag       ctermfg=251     ctermbg=none    cterm=none
"  highlight airline_y       ctermfg=9     ctermbg=none    cterm=none
"  highlight airline_b       ctermfg=10     ctermbg=none    cterm=none
"  highlight airline_b_bold  ctermfg=11     ctermbg=none    cterm=none
"  highlight airline_tab      ctermfg=11     ctermbg=none    cterm=none
  if g:kolorzalt_bold==0
    ...
    highlight Statement       ctermfg=32      ctermbg=none    cterm=none
    highlight Type            ctermfg=141     ctermbg=none    cterm=none
    highlight Error           ctermfg=32      ctermbg=none    cterm=none
    highlight Todo            ctermfg=80      ctermbg=none    cterm=none
    highlight Keyword         ctermfg=32     ctermbg=none    cterm=none
    ...
    highlight CursorLineNr    ctermfg=255     ctermbg=232     cterm=bold
    highlight Question        ctermfg=80      ctermbg=none    cterm=bold
    highlight WarningMsg      ctermfg=206     ctermbg=none    cterm=bold
    highlight Statement       ctermfg=32     ctermbg=none    cterm=bold
    highlight Type            ctermfg=251     ctermbg=none    cterm=bold
    highlight Error           ctermfg=168     ctermbg=none    cterm=bold
    highlight Todo            ctermfg=251     ctermbg=none    cterm=bold
    highlight Keyword         ctermfg=32      ctermbg=none    cterm=bold
    highlight Title           ctermfg=255     ctermbg=none    cterm=bold
    if g:kolorzalt_alternative_matchparen==0
      highlight MatchParen      ctermfg=235     ctermbg=39     cterm=bold
    else
